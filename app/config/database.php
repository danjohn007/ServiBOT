...
class Database {
    ...
    private function createSQLiteTables() {
        ...
        CREATE TABLE IF NOT EXISTS users (
            ...
            role VARCHAR(20) NOT NULL CHECK(role IN ('superadmin', 'cliente', 'prestador')),
        ...
        (1, 'admin@servibot.com', '\$2y\$10\$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'superadmin', 'Administrador ServiBOT', '555-0100', 'Oficina Central', 19.4326, -99.1332);
